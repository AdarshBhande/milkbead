      ...
      <div className="w-full max-w-md">
        <div className="card p-8">
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-full bg-lavender flex items-center justify-center mx-auto mb-4 shadow-lavender">
              <span className="text-3xl">✨</span>
            </div>
            <h1 className="font-nunito font-900 text-2xl text-softblack">Join Milkbead!</h1>
            <p className="font-inter text-sm text-gray-400 mt-1">Create your account and start shopping 💖</p>
          </div>
